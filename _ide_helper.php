...
namespace Illuminate\Support\Facades {
     ...
     */ class DB
    {
         ...
         *
         * @param Builder|\Closure|Expression|string $table
     ...
     */ class Http
    {
         ...
         *
         * @param string                                                     $url
         * @param callable|\Illuminate\Http\Client\Response|PromiseInterface $callback
         *
         * @return \Illuminate\Http\Client\Factory
         *
         * @static
     ...
     */ class Request
    {
         ...
         *
         * @param null|string             $key
         * @param null|array|Model|string $default
         *
         ...
         * @param mixed       $default
         *
         * @return null|array|UploadedFile|UploadedFile[]
         *
         * @static
         */
     ...
     */ class Storage
    {
         ...
         *
         * @param \Illuminate\Http\File|string|UploadedFile            $path
         * @param null|array|\Illuminate\Http\File|string|UploadedFile $file
         * @param mixed                                                $options
         *
         * @return false|string
         *
...
namespace Sentry\Laravel {
     ...
     */ class Facade
    {
         ...
         * @param mixed          $slug
         * @param mixed          $status
         * @param null|mixed     $monitorConfig
         * @param null|mixed     $checkInId
         *
         * @static
         */
...
namespace Spatie\LaravelIgnition\Facades {
     ...
     */ class Flare
    {
        ...
        /**
         * @param null|ArgumentReducers|array<ArgumentReducer|class-string<ArgumentReducer>> $argumentReducers
         *
         * @static
         */
        ...
        /**
         * @param array<FlareMiddleware>|callable|class-string<FlareMiddleware>|\Spatie\FlareClient\FlareMiddleware\FlareMiddleware $middleware
         *
...
namespace Illuminate\Console\Scheduling {
    class Event
    {
         ...
         *
         * @param null|string $monitorSlug
         * @param null|int    $checkInMargin
         * @param null|int    $maxRuntime
         * @param bool        $updateMonitorConfig
         * @param null|int    $failureIssueThreshold
         * @param null|int    $recoveryThreshold
         *
         * @static
         */
        ...
        {
            return Event::sentryMonitor($monitorSlug, $checkInMargin, $maxRuntime, $updateMonitorConfig, $failureIssueThreshold, $recoveryThreshold);
        }
    }
}
...
namespace {
    ...
    class Eloquent extends Model
    {
         ...
         * @param array|string $columns
         *
         * @return null|Illuminate\Database\Eloquent\Collection|Model|static|static[]
         *
         * @static
         */
         ...
         * @param null|Closure         $callback
         *
         * @return Illuminate\Database\Eloquent\Collection|mixed|Model|static|static[]
         *
         * @static
         */
         ...
         *
         * @param Illuminate\Database\Eloquent\Collection<Model>|Model $related
         ...
         *
         * @param Builder|Closure|Illuminate\Database\Query\Builder|string $query
         * @param string                                                   $as
         *
         * @return Illuminate\Database\Query\Builder
         *
         ...
         *
         * @param Builder|Closure|Illuminate\Database\Query\Builder|string $table
         * @param null|string                                              $as
         *
         * @return Illuminate\Database\Query\Builder
         *
         ...
         *
         * @param Expression|string              $table
         * @param null|Closure|Expression|string $first
         * @param null|string                    $operator
         * @param null|Expression|string         $second
         *
         * @return Illuminate\Database\Query\Builder
         ...
         *
         * @param Builder|Closure|Illuminate\Database\Query\Builder $callback
         * @param string                                            $boolean
         * @param bool                                              $not
         *
         * @return Illuminate\Database\Query\Builder
         ...
         *
         * @param Builder|Closure|Expression|Illuminate\Database\Query\Builder|string $column
         ...
         *
         * @param null|Closure|Expression|Illuminate\Database\Query\Builder|string $column
         * @param string                                                           $direction
         *
         * @return Illuminate\Database\Query\Builder
         *
         ...
         *
         * @param Builder|Closure|Illuminate\Database\Query\Builder $query
         * @param bool                                              $all
         *
         * @return Illuminate\Database\Query\Builder
         *
